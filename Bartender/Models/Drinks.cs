...
namespace Bartender.Models
{
    public class Drinks
    {
        ...
        public int AlcContent { get; set; }
        public int Cost { get; set; }
        public string Description { get; set; }
        public List<Drinks> Menu = new List<Drinks>();
